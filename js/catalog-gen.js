function createProductCard(product) {
  ...
  return `
    <div class="product">
      <div class="product-img multi-img" tabindex="0">
        ${imagesHtml}
      </div>
...
document.querySelectorAll('.product-img.multi-img').forEach(function(container) {
  ...
  container.addEventListener('touchend', e => {
    ...
    if (Math.abs(startX - endX) > 30) {
      if (endX < startX) index = (index + 1) % imgs.length;
